...
namespace Likewares\Sortable;

use Likewares\Sortable\View\Components\SortableLink;
    ...
    public function registerBladeDirectives()
    {
        $this->callAfterResolving('blade.compiler', function (BladeCompiler $compiler) {
            $compiler->directive('sortablelink', function ($expression) {
                ...
                return "<?php echo \Likewares\Sortable\Support\SortableLink::render(array ({$expression}));?>";
            });
        });
    }
